...
const {Text} = Typography
  ...
  const ManagerLayout: React.FC<LayoutProps> = ({children,width=80}) => {
          ...
          <Row>
            ...
            <Col style={{display:'flex', justifyContent:'space-between',alignItems:'center'}} offset={1} span={22}>
                <div style={{display:'flex', width:'350px',  height:'100%', justifyContent:'space-between'}}>
                  ...
                  <div style={{height:'100%',display:'flex',alignItems:'center'}}> <Link  href={`/manager/organizations/approved`} ><a style={{color:`${selectedRoute==='organizations'?'#1890ff':'black'}`}}>Organizations</a></Link> </div>
